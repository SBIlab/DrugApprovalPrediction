...
perf = pd.read_csv('../../result/result_in_paper/df_prediction_performance.tsv', sep = '\t')
proba = pd.read_csv('../../result/result_in_paper/df_approval_probability.tsv', sep = '\t')
...
plt.ylabel('AUPRC')
plt.tight_layout()
plt.savefig('../../result/result_in_paper/prediction_performance_box_plot.eps', dpi = 300, format = 'eps')
plt.savefig('../../result/result_in_paper/prediction_performance_box_plot.jpg', format = 'jpg')
plt.close()
...
for feature in ['OGE_CGE','OGE_CGE_Network_Expression_Chemical']:
	...
	plt.tight_layout()
	plt.savefig('../../result/result_in_paper/approval_probability_' + feature + '.eps', dpi = 300, format = 'eps')
	plt.savefig('../../result/result_in_paper/approval_probability_' + feature + '.jpg', format = 'jpg')
	plt.close()
